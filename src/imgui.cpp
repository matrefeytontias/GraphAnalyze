...
// Prefer just including imgui_internal.h from your code rather than using this define.
//If a declaration is missing from imgui_internal.h add it or request it on the github.
